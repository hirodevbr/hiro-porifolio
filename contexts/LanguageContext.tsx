...
const translations = {
  pt_BR: {
    ...
    discord_servers_belugang_desc: "Fui moderador no Belugang, ajudando a manter a comunidade organizada e segura.",
    discord_servers_celestrial_desc: "Fui moderador no Celestrial Boundaries, apoiando a comunidade e a moderação.",
    discord_servers_leaguehu3br_desc: "Fui moderador e Líder de Desenvolvimento no LEAGUE of Hu3BR.",
  ...
  en_US: {
    ...
    discord_servers_belugang_desc: "I was a moderator on Belugang, helping keep the community organized and safe.",
    discord_servers_celestrial_desc: "I was a moderator on Celestrial Boundaries, supporting the community and moderation.",
    discord_servers_leaguehu3br_desc: "I was a moderator and Development Lead at LEAGUE of Hu3BR.",
