...
const translations = {
  pt_BR: {
    ...
    bughunter_description_1: "Sou caçador de bugs em servidores Discord, sites e aplicações web.",
    ...
    bughunter_log_scanning: "[scan] Procurando bugs em Discord, sites, web apps e APIs...",
  ...
  en_US: {
    ...
    bughunter_description_1: "I'm a bug hunter in Discord servers, websites and web apps.",
    ...
    bughunter_log_scanning: "[scan] Looking for bugs in Discord, websites, web apps and APIs...",
