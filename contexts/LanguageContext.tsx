...
const translations = {
  pt_BR: {
    ...
    discord_last_played_activities: "Últimas atividades",
    discord_stopped_ago: "Parou há",
    discord_played_for: "Tempo jogado",
    discord_ago: "Há",
    discord_time_left: "Faltam",
    ...
    // Badges
    badge_discord_staff: "Funcionário do Discord",
    badge_discord_partner: "Parceiro do Discord",
    badge_hypesquad_events: "HypeSquad Events",
    badge_bug_hunter_1: "Bug Hunter Nível 1",
    badge_hypesquad_bravery: "HypeSquad Bravery",
    badge_hypesquad_brilliance: "HypeSquad Brilliance",
    badge_hypesquad_balance: "HypeSquad Balance",
    badge_early_supporter: "Early Supporter",
    badge_bug_hunter_2: "Bug Hunter Nível 2",
    badge_verified_bot_developer: "Desenvolvedor de Bot Verificado",
    badge_certified_moderator: "Moderador Certificado",
    badge_active_developer: "Desenvolvedor Ativo",
    badge_nitro: "Nitro",
    badge_nitro_classic: "Nitro Classic",
    badge_pomelo: "Pomelo",
    badge_server_boost: "Impulso de Servidor",
    badge_mission_complete: "Missão Completa",
    badge_orb: "Orb",
    discord_servers_title: "Servidores Discord",
    discord_servers_subtitle: "Servidores onde atuo como moderador e desenvolvedor",
    discord_servers_tab_community: "Moderação & Desenvolvedor",
    ...
    discord_servers_itsatrap_desc: "Moderador • Ajudo a manter o servidor organizado e seguro (regras, suporte aos membros e prevenção de spam). Também colaboro com a equipe para melhorar a experiência da comunidade.",
    ...
    discord_servers_chiliz_desc: "Moderador e Desenvolvedor • Ajudo na moderação e também contribuo com melhorias técnicas, automações e ajustes que apoiam a rotina da comunidade.",
    discord_servers_communityorg_dev_desc: "Gerente de Comunidade e Desenvolvedor • Lidero iniciativas e ajudo a estruturar a comunidade (comunicação, organização e metas). Também facilito o trabalho da equipe e acompanho a saúde da comunidade no dia a dia.",
  ...
  en_US: {
    ...
    discord_last_played_activities: "Last played",
    discord_stopped_ago: "Stopped",
    discord_played_for: "Played for",
    discord_ago: "Ago",
    discord_time_left: "Time left",
    ...
    // Badges
    badge_discord_staff: "Discord Staff",
    badge_discord_partner: "Discord Partner",
    badge_hypesquad_events: "HypeSquad Events",
    badge_bug_hunter_1: "Bug Hunter Level 1",
    badge_hypesquad_bravery: "HypeSquad Bravery",
    badge_hypesquad_brilliance: "HypeSquad Brilliance",
    badge_hypesquad_balance: "HypeSquad Balance",
    badge_early_supporter: "Early Supporter",
    badge_bug_hunter_2: "Bug Hunter Level 2",
    badge_verified_bot_developer: "Verified Bot Developer",
    badge_certified_moderator: "Certified Moderator",
    badge_active_developer: "Active Developer",
    badge_nitro: "Nitro",
    badge_nitro_classic: "Nitro Classic",
    badge_pomelo: "Pomelo",
    badge_server_boost: "Server Boost",
    badge_mission_complete: "Mission Complete",
    badge_orb: "Orb",
    discord_servers_title: "Discord Servers",
    discord_servers_subtitle: "Servers where I work as a moderator and developer",
    discord_servers_tab_community: "Moderation & Development",
    ...
    discord_servers_itsatrap_desc: "Moderator • I help keep the server organized and safe (rules, member support, and anti-spam). I also collaborate with the team to improve the community experience.",
    ...
    discord_servers_chiliz_desc: "Moderator & Developer • I help with moderation and also contribute technical improvements, automation, and refinements that support community operations.",
    discord_servers_communityorg_dev_desc: "Community Manager & Developer • I lead initiatives and help structure the community (communication, organization, and goals). I also support the team and monitor community health day to day.",
