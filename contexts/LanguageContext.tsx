...
const translations = {
  pt_BR: {
    ...
    discord_servers_tab_community: "Moderação & Dev",
    ...
    discord_servers_chiliz_desc: "Moderador e Dev • Ajudo na moderação e também contribuo com melhorias técnicas, automações e ajustes que apoiam a rotina da comunidade.",
  ...
  en_US: {
    ...
    discord_servers_tab_community: "Moderation & Dev",
    ...
    discord_servers_chiliz_desc: "Moderator & Dev • I help with moderation and also contribute technical improvements, automation, and refinements that support community operations.",
